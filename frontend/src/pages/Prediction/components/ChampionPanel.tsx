        ...
        return (
            <div style={{display: "flex", flexDirection: "column", justifyContent: "center", width: "100%"}}>
                <Input 
                    ...
                    role="Top" onClick={() => this.props.selectBox(0)}
                ...
                <Input 
                    isFriendlyTeam={this.props.isFriendlyTeam} 
                    role="Jungle" onClick={() => this.props.selectBox(1)}
                ...
                <Input 
                    isFriendlyTeam={this.props.isFriendlyTeam} 
                    role="Mid" onClick={() => this.props.selectBox(2)}
                ...
                <Input 
                    isFriendlyTeam={this.props.isFriendlyTeam} 
                    role="Bot" onClick={() => this.props.selectBox(3)}
                ...
                <Input 
                    isFriendlyTeam={this.props.isFriendlyTeam} 
                    role="Support" onClick={() => this.props.selectBox(4)}
